...
class NewSiteForm(forms.Form):
    site = forms.CharField(label="New Site")
...
def add_to_blacklist(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(reverse("scraping:summary"))
