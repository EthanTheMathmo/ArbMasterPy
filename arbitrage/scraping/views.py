...
def webhook(request):
    ...
    if request.method == "POST":
        ...
        webhook_secret = os.getenv('whsec_dtE7lhWPRens3lkdoDtrZu3SqcsOKiCn')
        ...
        return render(request, "scraping/webhook.html")


def purchases(request):

    return render(request, "scraping/purchases.html")
